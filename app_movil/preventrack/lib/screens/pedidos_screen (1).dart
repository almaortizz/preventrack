...
class _PedidosScreenState extends State<PedidosScreen> {
  ...
  final List<String> _filtros = ['Todos', 'Pendientes', 'En ruta', 'Entregados', 'Cancelados'];
      ...
      children: [
                  ...
                  : pedidosFiltrados.isEmpty
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              Icon(Icons.receipt_long_outlined, size: 56, color: AppColors.textPrimary.withValues(alpha: 0.2)),
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => _buildPedidoCard(pedidosFiltrados[index]),
                          ),
                        ),
            ),
          ],
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            onPressed: () {
              // TODO: Navegar a pantalla de crear pedido (seleccionar cliente primero)
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Crear pedido — próximamente'),
        ...
        child: Container(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              color: isSelected ? AppColors.white : AppColors.textPrimary.withValues(alpha: 0.6),
            ),
          ),
        ),
      ),
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      'FECHA',
                      style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.textPrimary.withValues(alpha: 0.4), letterSpacing: 0.5),
                    ),
